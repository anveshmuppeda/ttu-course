...
def recognize_selected_image(selected_filename):
    ...
    return best_match_label, selected_filename.split("/")[0]

# Example usage:
selected_filename = "Grp13Person8/80_8.jpg"  # Replace with the filename of the selected image
predicted_person, actual_person = recognize_selected_image(selected_filename)
print("Predicted Person:", predicted_person)
print("Actual Person:", actual_person)
